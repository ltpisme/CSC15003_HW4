...
| -------------------- | -------------------------------------- | ------------------------------------------ | -------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- | ---------- |
| **TC_FR02_01** | Login với email và password hợp lệ | Account`test@eshop.com` không bị khóa | 1. Mở Login2. Nhập email hợp lệ3. Nhập password đúng4. Submit | Login thành công, chuyển tới trang sau đăng nhập/trang chủ; không hiển thị lỗi           | E1, E3, E5 |
| **TC_FR02_02** | Login với email sai định dạng      | Đang ở Login                             | 1. Nhập`invalid-email`2. Nhập password3. Submit                  | Browser hiển thị validation email; không thực hiện login                                        | E2, C1     |
| **TC_FR02_03** | Login với email không tồn tại      | Account không bị khóa                   | 1. Nhập`unknown@eshop.com`2. Nhập password3. Submit              | Login thất bại; hiển thị thông báo lỗi chung, không tiết lộ email có tồn tại hay không | E4         |
| **TC_FR02_04** | Login với password sai                | Account không bị khóa                   | 1. Nhập`test@eshop.com`2. Nhập `WrongPass`3. Submit            | Login thất bại; hiển thị thông báo lỗi phù hợp                                              | E6         |
...
| **Steps**        | 1. Mở Login2. Nhập `test@eshop.com`3. Nhập `WrongPass`4. Submit |
...
| **Precondition** | Account không bị khóa                                                                                     |
| **Steps**        | 1. Login với password sai → lần 12. Login tiếp với password sai → lần 2                               |
...
| **Precondition** | Account không bị khóa                                                                                                                    |
| **Steps**        | 1. Login sai lần 12. Login sai lần 23. Login sai lần 3                                                                                   |
...
| **Steps**        | 1. Nhập`test@eshop.com`2. Nhập `Test1234!` đúng3. Submit                                                                         |
...
| **Steps**        | 1. Chờ đủ 30 giây2. Nhập `test@eshop.com`3. Nhập `Test1234!`4. Submit |
...
| Steps      | 1. Focus vào đầu form2. Nhấn Tab tuần tự3. Ghi nhận element nhận focus |
