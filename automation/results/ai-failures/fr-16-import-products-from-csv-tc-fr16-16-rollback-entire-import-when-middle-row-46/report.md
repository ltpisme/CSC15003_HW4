...
## Test Location
/home/ltp/CSC15003_HW4/automation/tests/fr16.spec.ts:880

46) tests/fr16.spec.ts:880:7 › FR-16 - Import Products from CSV › TC_FR16_16 - Rollback entire import when middle row is invalid
Duration: 5190ms
...
Call log:
  ...
  - waiting for locator('input[type="file"]').first()
    ...
    at /home/ltp/CSC15003_HW4/automation/tests/fr16.spec.ts:903:15
```
